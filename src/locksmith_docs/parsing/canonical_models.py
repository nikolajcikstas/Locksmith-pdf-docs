...
CANONICAL_MODELS: dict[str, list[str]] = {
    ...
    "Infiniti": ["EX35", "FX35", "FX45", "G35", "G37", "I30", "I35", "JX35", "M35", "M45", "Q45", "Q50", "Q60", "QX4", "QX56", "QX60", "QX80"],
    ...
    "Nissan": ["200SX", "240SX", "260Z", "280Z", "Armada", "Frontier", "Maxima", "Murano", "Pathfinder", "Pickup", "Pulsar", "Quest", "Rogue", "Sentra", "Titan", "Versa", "Xterra"],
