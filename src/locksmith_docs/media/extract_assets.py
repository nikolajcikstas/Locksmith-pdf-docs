...
def render_blade_orientation_svg(schema: dict[str, Any]) -> str:
    ...
    return "".join([
        ...
        '<rect width="100%" height="100%" rx="20" fill="#f7fafb"/>',
        '<style>text{font-family:Arial,sans-serif;fill:#142536}.title{font-size:22px;font-weight:700}.sub{font-size:14px;fill:#526477}.label{font-size:13px;font-weight:700}.track{font-size:13px;fill:#526477}.blade{fill:#e8eef1;stroke:#264456;stroke-width:3}.head{fill:#142d3c}.hole{fill:#f7fafb}.cut{stroke:#0f766e;stroke-width:8;stroke-linecap:round}.guide{stroke:#2563a6;stroke-width:5;stroke-dasharray:12 9;stroke-linecap:round}</style>',
        f'<text class="title" x="38" y="46">{xml_escape(profile)} blade orientation</text>',
        f'<text class="sub" x="38" y="71">{xml_escape(milling)} technical reference; handle at left and tip at right.</text>',
        '<line class="cut" x1="458" y1="102" x2="500" y2="102"/>',
        '<text class="label" x="516" y="98">CUT TRACK</text>',
        f'<text class="track" x="516" y="116">{xml_escape(cut_track)}</text>',
        '<line class="guide" x1="790" y1="102" x2="832" y2="102"/>',
        '<text class="label" x="848" y="98">GUIDE TRACK</text>',
        f'<text class="track" x="848" y="116">{xml_escape(guide_track)}</text>',
        '<path class="head" d="M70 171 C70 141 94 118 124 118 H201 C231 118 255 142 255 172 V262 C255 292 231 315 201 315 H124 C94 315 70 292 70 262 Z"/>',
        '<path class="hole" d="M112 180 C112 162 126 148 144 148 H177 C195 148 209 162 209 180 V252 C209 270 195 284 177 284 H144 C126 284 112 270 112 252 Z"/>',
        '<path class="blade" d="M244 176 H865 L945 217 L865 258 H244 Z"/>',
        '<path class="cut" d="M282 200 H844"/>',
        '<path class="guide" d="M282 233 H844"/>',
        '<text class="sub" x="105" y="339">HANDLE</text><text class="sub" x="862" y="282">TIP</text>',
        f'<text class="sub" x="292" y="302">{xml_escape(note)}</text>',
        '<text class="sub" x="292" y="327">Use the spacing and depth tables below when cutting a working blade.</text>',
        '</svg>',
    ])
